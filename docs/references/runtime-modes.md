...
Running the script:
- Run the runner under a process manager (e.g. pm2) so it stays alive across turns/games and auto-restarts on crash.
- If you change the script, restart the process for the changes to take effect.
